...
public class TestXmlRpcClient {
	...
	public static void main(String[] args) {
		...
		try {
			...
			config.setServerURL(new URL("http://10.61.38.108:10011/Air"));
			...
			/*
			 * config.setBasicUserName("userRpc1"); config.setBasicPassword("passRpc1");
			 */
			// XmlRpcClient client = new XmlRpcClient();
			...
			/*
			 * params.addElement(new Integer(10)); params.addElement(new Integer(50));
			 */
